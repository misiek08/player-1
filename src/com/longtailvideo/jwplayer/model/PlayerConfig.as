package com.longtailvideo.jwplayer.model {
	...
	public dynamic class PlayerConfig extends EventDispatcher {
		...
		protected var _bufferlength:Number 	= 1; 
		...
		protected var _stretching:String 	= "autofill";
		...
		/** ?pc has been added as prevent cache **/
		public function get playlistfile():String  { return _playlistfile + "?pc=" + new Date().getTime(); }
